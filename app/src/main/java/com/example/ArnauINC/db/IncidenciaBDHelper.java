...
import com.example.ArnauINC.db.IncidenciaContract.*;
...
import static com.example.ArnauINC.db.IncidenciaContract.IncidenciaEntry.DATABASE_NAME;
import static com.example.ArnauINC.db.IncidenciaContract.IncidenciaEntry.DATABASE_VERSION;
    ...
    public void insertIncidencia(SQLiteDatabase db, Incidencia miincidencia) {
        if(db.isOpen()){
            ...
            try {
                ...
                Log.i("prueba","insert not happened");
            }
        }else{
            Log.i("prueba","database is closed");
        }
    }
